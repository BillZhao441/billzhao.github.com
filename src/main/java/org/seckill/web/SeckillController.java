...
public class SeckillController {
    ...
    @ResponseBody
    public SeckillResult<SeckillExcution> execution(@PathVariable("seckillId") Long seckillId, @PathVariable("md5") String md5, @CookieValue(value = "killPhone", required = false) Long phone){
        if(phone==null){
            return new SeckillResult<SeckillExcution>(false, "haven't logged in");
        }
        try{
            ...
            SeckillExcution seckillExcution=new SeckillExcution(seckillId, SeckillStatusEnum.REPEAT_SECKILL);
            return new SeckillResult<SeckillExcution>(true, seckillExcution);
